...
(function () {
    ...
    var panZoomFunctions = {
        ...
        panZoomIn: function (steps, centerPoint){
    ...
    PanZoom = function (el, options) {
        ...
        container.onmousedown = function (e) {
            ...
            if (!me.enabled || me.panDisabled) return false;
            me.dragTime = 0;
...
//        }
        ...
        function pan(deltax, deltay) {
            ...
            var centerPoint = {x: deltax, y: deltay};

            deltaX = ((paper.width * settings.zoomStep) * (centerPoint.x / paper.width));
            deltaY = (paper.height * settings.zoomStep) * (centerPoint.y / paper.height);
